...
describe("Pool", function () {
  ...
  it("add new addrs as they are announced over the network", function (done) {
    ...
    var peerMessageStub = sinon.stub(
      Peer.prototype,
      "_readMessage",
      function () {
  ...
  it("propagate connect, ready, and disconnect peer events", function (done) {
    ...
    var peerDisconnectStub = sinon.stub(
      Peer.prototype,
      "disconnect",
      function () {
  ...
  it("output the console correctly", function () {
    ...
    pool
      .inspect()
      .should.equal("<Pool network: livenet, connected: 0, available: 0>");
  });
